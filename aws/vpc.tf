...
# Terraform does not create this resource, but instead "adopts" it into management. If no default VPC exists, 
# Terraform creates a new default VPC, which leads to the implicit creation of other resources. 
